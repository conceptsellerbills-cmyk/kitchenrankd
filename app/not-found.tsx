...
export default function NotFound() {
  ...
  return (
    <>
      <style>{`
        .nf-wrap{min-height:70vh;display:flex;flex-direction:column;align-items:center;justify-content:center;padding:60px 24px;text-align:center;background:#110a00}
        .nf-code{font-size:clamp(5rem,15vw,9rem);font-weight:900;line-height:1;background:linear-gradient(135deg,#f59e0b55,#f59e0b);-webkit-background-clip:text;-webkit-text-fill-color:transparent;background-clip:text;margin-bottom:8px}
        ...
        .nf-btn-primary{background:#f59e0b;color:#fff;border:none;padding:12px 28px;border-radius:8px;font-size:0.95rem;font-weight:700;cursor:pointer;text-decoration:none;transition:opacity 0.15s}
        ...
        .nf-btn-secondary:hover{border-color:#f59e0b;color:#f59e0b}
        ...
        .nf-card:hover{border-color:#f59e0b;transform:translateY(-2px)}
