...
export const metadata: Metadata = { title: "Write for Us — KitchenRankd", description: "Contribute a guest post to KitchenRankd. Share your expertise on kitchen and cooking products." };
...
`}</style>
      <div className="page-wrap">
        ...
        <p className="page-subtitle">We welcome guest contributors who can bring original insights and expertise to our readers. If you know kitchen and cooking products well, we'd love to publish your work.</p>
        <hr className="page-divider" />
        <h2>What We're Looking For</h2>
        <ul>
          <li>Original, well-researched articles on kitchen and cooking products</li>
        ...
        <h2>How to Pitch</h2>
        <p>Email us at <a href="mailto:hello@kitchenrankd.com">hello@kitchenrankd.com</a> with the subject line "Guest Post Pitch" and include:</p>
        <ul>
