    ...
    <>
      <style>{`
        *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        .hero-bg { position: absolute; inset: 0; background: radial-gradient(ellipse 80% 60% at 50% -10%, rgba(249,115,22,0.18) 0%, transparent 70%), radial-gradient(ellipse 60% 40% at 80% 80%, rgba(239,68,68,0.1) 0%, transparent 60%); pointer-events: none; }
      ...
      <section className="hero">
        ...
        <div className="hero-badge">Tested in Real Kitchens</div>
        <h1 dangerouslySetInnerHTML={{ __html: "Kitchen Products<br />Actually Worth Buying" }} />
        <p>Real-kitchen testing of cookware, appliances, knives and gadgets. Find tools that last, perform beautifully and make cooking a daily joy.</p>
        <div className="hero-ctas">
          <a href="/top-kitchen-gear" className="hero-cta-primary">View Kitchen Rankings →</a>
          <a href="/categories" className="hero-cta-secondary">Browse Categories →</a>
        </div>
        <div className="stats-bar">
          {([{"v":"600+","l":"Products Ranked"},{"v":"100+","l":"Recipes Tested"},{"v":"3 Months","l":"Avg Test Period"},{"v":"2025","l":"Current"}] as {v:string,l:string}[]).map((st) => (
      ...
      <div className="container">
        ...
        <section className="section" style={{ paddingBottom: 40 }}>
          ...
          <div className="trending-row">
            {([{"label":"Best Air Fryers 2025","hot":true,"href":"/best-air-fryers"},{"label":"All-Clad vs Made In","hot":true,"href":"/all-clad-vs-made-in"},{"label":"Best Chef Knives","href":"/best-chef-knives"},{"label":"Instant Pot Review","href":"/instant-pot-review"},{"label":"Best Espresso Machines","hot":true,"href":"/best-espresso-machines"},{"label":"Non-Toxic Cookware","href":"/non-toxic-cookware-guide"}] as {label:string,hot?:boolean,href:string}[]).map((t) => (
        ...
        <section className="section" style={{ paddingTop: 20 }}>
          ...
          <div className="section-header">
            <h2 className="section-title">Top Kitchen Products of 2025</h2>
          </div>
          <div className="picks-grid">
            {([{"badge":"Best Pan","badgeType":"gold","icon":"🥘","title":"Made In Blue Carbon","desc":"Professional-grade carbon steel that develops a naturally non-stick surface over time.","rating":5,"href":"/made-in-blue-carbon-review"},{"badge":"Best Air Fryer","badgeType":"silver","icon":"⚡","title":"Breville Joule Oven Air","desc":"The most versatile countertop oven — air fryer, toaster oven, and slow cooker in one.","rating":5,"href":"/breville-smart-oven-air-review"},{"badge":"Best Knife","badgeType":"bronze","icon":"🔪","title":"Wüsthof Classic 8\"","desc":"German precision engineering that holds its edge longer than any knife in its price range.","rating":5,"href":"/wusthof-classic-review"}] as {badge:string,badgeType:string,icon:string,title:string,desc:string,rating:number,href:string}[]).map((p, i) => (
        ...
        <section className="section">
          ...
          <div className="section-header">
            <h2 className="section-title">How We Rank Kitchen Products</h2>
          </div>
          <div className="how-grid">
            {([{"num":"01","title":"We Cook with Everything","desc":"Every product is cooked with — real meals, real recipes — for a minimum of 3 months."},{"num":"02","title":"We Test Durability","desc":"Pans are exposed to high heat, metal utensils and dishwashers. Knives are sharpened and used daily."},{"num":"03","title":"You Cook Better","desc":"Our rankings help you invest in tools that genuinely improve your cooking and last for years."}] as {num:string,title:string,desc:string}[]).map((h) => (
        ...
        <section className="section" style={{ paddingTop: 0 }}>
          ...
          <div className="category-grid">
            {([{"icon":"🥘","label":"Cookware","desc":"Pans, pots & Dutch ovens","href":"/category/cookware"},{"icon":"⚡","label":"Appliances","desc":"Air fryers, instant pots & more","href":"/category/appliances"},{"icon":"🔪","label":"Knives","desc":"Chef knives, sets & sharpeners","href":"/category/knives"},{"icon":"☕","label":"Coffee","desc":"Espresso, drip & pour-over","href":"/category/coffee"},{"icon":"🧊","label":"Storage","desc":"Containers, organizers & racks","href":"/category/storage"},{"icon":"🍞","label":"Baking","desc":"Mixers, bakeware & tools","href":"/category/baking"}] as {icon:string,label:string,desc:string,href:string}[]).map((c) => (
        ...
        <section className="section" style={{ paddingTop: 0 }}>
          ...
          <div className="section-header">
            <h2 className="section-title">Why Readers Trust KitchenRankd</h2>
          </div>
          <div className="why-grid">
            {([{"icon":"👨‍🍳","title":"Chefs Test Everything","desc":"Our reviewers are trained cooks who use these tools for actual meal prep — not just unboxing."},{"icon":"⏰","title":"3-Month Test Period","desc":"We use every product for at least 3 months across different cooking styles and recipes."},{"icon":"🔬","title":"Material Analysis","desc":"We research coating safety, metal composition and manufacturing claims — not just surface appearances."},{"icon":"💲","title":"True Value Rankings","desc":"We compare performance per dollar across budget, mid-range and premium categories."}] as {icon:string,title:string,desc:string}[]).map((w) => (
        ...
        <section className="section" style={{ paddingTop: 0 }}>
          ...
          <div className="faq-list">
            {([{"q":"What is the best cookware brand in 2025?","a":"Made In, All-Clad and Demeyere are our top picks for stainless steel. For non-toxic non-stick, we recommend Caraway and GreenPan."},{"q":"Is non-stick cookware safe?","a":"Modern PFAS-free non-stick coatings (ceramic, seasoned carbon steel, cast iron) are safe. We avoid recommending any cookware with PTFE coatings above 500°F."},{"q":"What knife should a beginner home cook buy?","a":"A single quality 8-inch chef's knife is all you need to start. The Victorinox Fibrox is exceptional value, and Wüsthof Classic is the best mid-range upgrade."},{"q":"Is an air fryer actually worth it?","a":"Yes — if you cook regularly. Air fryers reduce cooking time by 20-30% and produce genuinely crispier results than a conventional oven for many foods."},{"q":"What espresso machine do you recommend for home use?","a":"Breville Bambino Plus for beginners, Breville Barista Express for those who want an integrated grinder, and De'Longhi La Specialista for serious home baristas."}] as {q:string,a:string}[]).map((f) => (
        ...
        <div className="cta-section">
          <h2>Cook Better with the Right Tools</h2>
          <p>Stop buying kitchen gear that disappoints. Get honest rankings based on months of real cooking.</p>
          <a href="/top-kitchen-gear" className="cta-btn">Browse All Rankings →</a>
        </div>
