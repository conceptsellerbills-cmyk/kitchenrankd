...
export const metadata: Metadata = { title: "Cookie Policy — KitchenRankd", description: "Cookie Policy for KitchenRankd (kitchenrankd.com)." };
...
`}</style>
      <div className="page-wrap">
        ...
        <h2>Contact</h2>
        <p>If you have questions about our cookie use, contact us at <a href="mailto:hello@kitchenrankd.com">hello@kitchenrankd.com</a>.</p>
      </div>
    </>
  );
}
