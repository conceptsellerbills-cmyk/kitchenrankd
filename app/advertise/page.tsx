...
export const metadata: Metadata = { title: "Advertise — KitchenRankd", description: "Advertise with KitchenRankd and reach a targeted audience interested in kitchen and cooking products." };
...
`}</style>
      <div className="page-wrap">
        ...
        <h1 className="page-title">Advertise on KitchenRankd</h1>
        <p className="page-subtitle">Reach a highly engaged audience of readers actively researching and comparing kitchen and cooking products. Our visitors are decision-ready — they come here to find the best options.</p>
        ...
        <h2>Get in Touch</h2>
        <p>For pricing, media kit, and availability, contact us at <a href="mailto:hello@kitchenrankd.com">hello@kitchenrankd.com</a> with the subject line "Advertising Inquiry". We'll respond within 2 business days.</p>
      </div>
    </>
  );
}
