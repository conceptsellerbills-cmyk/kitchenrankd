...
export const metadata: Metadata = {
  ...
  alternates: {
    canonical: "/",
    types: {
      "application/rss+xml": [{ url: "/feed.xml", title: "Kitchen Ranked RSS Feed" }],
    },
  },
};
...
export default function RootLayout({ children }: { children: React.ReactNode }) {
  return (
    <html lang="en">
      <body>
        <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: `{"@context":"https://schema.org","@type":"WebSite","name":"Kitchen Ranked","url":"https://www.kitchenrankd.com","potentialAction":{"@type":"SearchAction","target":{"@type":"EntryPoint","urlTemplate":"https://www.kitchenrankd.com/all-articles?q={search_term_string}"},"query-input":"required name=search_term_string"}}` }} />
        <style>{`
        ...
        <Script
          src="https://www.googletagmanager.com/gtag/js?id=G-0QTK6B91LK"
