...
export const metadata: Metadata = {
  title: "All Articles — KitchenRankd",
  description: "Browse every article published on KitchenRankd.",
};
    ...
    <>
      <style>{`
        *,*::before,*::after{box-sizing:border-box;margin:0;padding:0}
        ...
        .aa-eyebrow{font-size:0.72rem;font-weight:700;letter-spacing:0.1em;text-transform:uppercase;color:#f59e0b;margin-bottom:8px}
        ...
        .aa-card{background:#151007;border:1px solid #1e2535;border-radius:12px;overflow:hidden;display:flex;flex-direction:column;transition:border-color 0.15s,transform 0.15s}
        .aa-card:hover{border-color:#f59e0b;transform:translateY(-2px)}
        ...
        .aa-tag{display:inline-block;font-size:0.68rem;font-weight:700;letter-spacing:0.07em;text-transform:uppercase;color:#f59e0b;background:#f59e0b18;border:1px solid #f59e0b30;padding:3px 10px;border-radius:20px;margin-bottom:12px;width:fit-content}
        .aa-card-title{font-size:0.98rem;font-weight:700;line-height:1.4;margin-bottom:8px;color:#e4e8f4}
        .aa-card-title:hover{color:#f59e0b}
        ...
        .aa-read{font-size:0.82rem;font-weight:600;color:#f59e0b}
