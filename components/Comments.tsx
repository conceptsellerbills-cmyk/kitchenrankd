...
export function Comments({ title }: CommentsProps) {
  ...
  useEffect(() => {
    ...
    script.setAttribute("data-repo", "conceptsellerbills-cmyk/kitchenrankd");
    script.setAttribute("data-repo-id", "R_kgDOR9GYWA");
    script.setAttribute("data-category", "General");
    script.setAttribute("data-category-id", "DIC_kwDOR9GYWM4C6gbY");
