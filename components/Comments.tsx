  ...
  return (
    <>
      <style>{`
        ...
        .c-reply-btn:hover{color:#f59e0b}
        ...
        .comment-submit{background:#f59e0b;color:#fff;border:none;border-radius:8px;padding:10px 24px;font-size:0.9rem;font-weight:700;cursor:pointer;transition:opacity 0.15s}
