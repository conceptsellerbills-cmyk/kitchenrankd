...
const CATEGORIES: { label: string; href: string }[] = [{"label":"☕ Coffee Makers","href":"/category/coffee-makers"},{"label":"🔪 Knives & Cutting","href":"/category/knives"},{"label":"🍳 Cookware Sets","href":"/category/cookware"},{"label":"🥘 Pressure Cookers","href":"/category/pressure-cookers"},{"label":"🥗 Blenders & Juicers","href":"/category/blenders"},{"label":"🍞 Air Fryers","href":"/category/air-fryers"},{"label":"🫙 Food Storage","href":"/category/food-storage"},{"label":"🧊 Refrigerators","href":"/category/refrigerators"},{"label":"🍕 Baking & Pastry","href":"/category/baking"},{"label":"🌡️ Thermometers","href":"/category/thermometers"},{"label":"🧹 Kitchen Cleaning","href":"/category/kitchen-cleaning"},{"label":"⚖️ Kitchen Gadgets","href":"/category/kitchen-gadgets"}];
...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  return {
    ...
    openGraph: {
      ...
      description: post.description || "",
      type: "article",
      url: `https://www.kitchenrankd.com/${slug}`,
      siteName: "Kitchen Ranked",
    ...
    alternates: { canonical: `https://www.kitchenrankd.com/${slug}` },
  };
}
...
export default async function ArticlePage({ params }: Props) {
  ...
  const schema = JSON.stringify({
    ...
    url: `https://www.kitchenrankd.com/${slug}`,
    mainEntityOfPage: { "@type": "WebPage", "@id": `https://www.kitchenrankd.com/${slug}` },
    author: { "@type": "Organization", name: "Kitchen Ranked", url: "https://www.kitchenrankd.com" },
    publisher: {
      "@type": "Organization",
      name: "Kitchen Ranked",
      url: "https://www.kitchenrankd.com",
      logo: { "@type": "ImageObject", url: "https://www.kitchenrankd.com/logo.png", width: 200, height: 60 }
    },
    keywords: post.keyword || "",
  });
  ...
  const breadcrumbSchema = JSON.stringify({
    ...
    "@type": "BreadcrumbList",
    itemListElement: [
      { "@type": "ListItem", position: 1, name: "Home", item: "https://www.kitchenrankd.com" },
      ...(post.category ? [{ "@type": "ListItem", position: 2, name: post.category.replace(/-/g, " ").replace(/\b\w/g, (l: string) => l.toUpperCase()), item: `https://www.kitchenrankd.com/category/${post.category}` }] : []),
      { "@type": "ListItem", position: post.category ? 3 : 2, name: post.title, item: `https://www.kitchenrankd.com/${slug}` },
    ],
  });
    ...
    <>
      <style>{`
        *,*::before,*::after{box-sizing:border-box;margin:0;padding:0}
        :root{--bg:#0d0a04;--surface:#111520;--border:#1e2535;--text:#e4e8f4;--muted:#7a82a0;--accent:#f59e0b;--radius:10px}
          ...
          <article className="article">
            ...
            <div className="author-box">
              ...
              <div className="author-info">
                <div className="author-name">Kitchen Ranked Editorial Team</div>
