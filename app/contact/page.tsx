...
export const metadata: Metadata = { title: "Contact — KitchenRankd", description: "Get in touch with the KitchenRankd team." };
...
`}</style>
      <div className="page-wrap">
        ...
        <div className="info-card">
          ...
          <p>For faster responses, email us at <a href="mailto:hello@kitchenrankd.com">hello@kitchenrankd.com</a>. We reply within 1–2 business days.</p>
        </div>
